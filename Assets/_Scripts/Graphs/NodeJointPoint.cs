...
public class NodeJointPoint
{
    ...
    {
        get { return NodeDrawableBase.allDrawableBases.FirstOrDefault(node => node.Id == ParentId); }
    }
    ...
    [TDataMember] public RectEditorProxy
        actionRectProxy;

    [TDataMember] public Vector2EditorProxy
        offsetProxy;
